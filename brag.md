...
3. [Experiências Profissionais](#experiências-profissionais)
...
|-----------|-------------|
| **Linguagens** | Java 7, Java 8, Java 11, Kotlin, JavaScript/TypeScript |
| **Frameworks** | Spring Boot, Spring MVC, Spring Data JPA, Hibernate, React, React Native, Next.js |
| **Cloud & Infra** | AWS (Cognito, RDS, DynamoDB), GCP (GKE, Secret Manager), Docker, Docker Compose, Kubernetes, Helm |
| **Banco de Dados** | PostgreSQL, MySQL |
| **Observabilidade** | Grafana, JMeter, Postman |
| **DevOps & CI/CD** | GitHub Actions, Workload Identity Federation, Jenkins, GitLab |
| **Outros** | Microservices, REST APIs, Elastic Path e-commerce, Cloudflare CDN |
...
_(Total na Wine.com.br: ~4 anos e 1 mês)_
...
**Frontend & Produto**
- ✅ Internacionalização multi-idioma com **react-i18next** (Next.js)
...
- ✅ Participou do **LinkedIn Launchpad: Coaches for Career Starters** — destacado nominalmente pelo coach Eduardo Almeida (Product Integrity Consultant @ LinkedIn)
